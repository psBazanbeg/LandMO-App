...
public class HRRList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrrlist);
        getSupportActionBar().setTitle("Repair History");
    ...
    {
        Cursor cursor = DB.getdata_repair_for();
        if(cursor.getCount()==0)
        {
            Toast.makeText(HRRList.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
            return;
        }
        else
        {
