...
public class RRList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rrlist);
    ...
    {
        Cursor cursor = DB.getdata_repair_for_office();
        if(cursor.getCount()==0)
        {
            Toast.makeText(RRList.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
            return;
        }
        else
        {
