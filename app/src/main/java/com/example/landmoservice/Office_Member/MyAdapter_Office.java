...
import com.example.landmoservice.Tech_Officer.RepairDitails;

import java.util.ArrayList;

public class MyAdapter_Office extends RecyclerView.Adapter<MyAdapter_Office.MyViewHolder> {
    private Context context;
    private ArrayList name_id, email_id, age_id ,RID_id;

    public MyAdapter_Office(Context context, ArrayList name_id, ArrayList email_id, ArrayList age_id, ArrayList RID_id) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(holder.age_id.getText().toString().equals("Complete")){
        ...
        else if(holder.age_id.getText().toString().equals("Processing...")){
            ...
            holder.age_id.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(txt.equals("RI")) {
                        Intent intent = new Intent(context, Accept_Repair.class);
