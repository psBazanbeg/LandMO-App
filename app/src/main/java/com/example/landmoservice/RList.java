...
public class RList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Repair Request History");
    ...
    {
        Cursor cursor = DB.getdata_repair(CID);
        if(cursor.getCount()==0)
        {
            Toast.makeText(RList.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
            return;
        }
        else
        {
