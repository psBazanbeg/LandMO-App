...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyAdapter(Context context, ArrayList name_id, ArrayList email_id, ArrayList age_id,ArrayList RID_id) {
        ...
        if(holder.age_id.getText().toString().equals("Complete")){
            ...
            holder.age_id.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(txt.equals("RI")) {
                        Intent intent = new Intent(context, AcceptedVeiwActivity.class);
                        intent.putExtra("RSID", id);
                        context.startActivity(intent);

                    }
                    if(txt.equals("SI")) {
                        Intent intent = new Intent(context, AcceptedVeiwActivity2.class);
                        intent.putExtra("RSID", id);
                        context.startActivity(intent);
